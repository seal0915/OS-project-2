...
static int master_mmap(struct file *targetFile, struct vm_area_struct *vma);
...
static const struct vm_operations_struct master_mmap_operations = {
	.open = mmap_open,
	.close = mmap_close//,
//	.fault = mmap_fault
//	.nopage
...
// ref https://edsionte.com/techblog/archives/3993
void mmap_open(struct vm_area_struct *vma){
...
// ref https://blog.csdn.net/zqy2000zqy/article/details/1137892	
	...
	vma->vm_ops = &master_mmap_operations;
